...
public class MethodDeclNamespace implements SyntaxNode {
    ...
    public MethodDeclNamespace (TypeOrVoid TypeOrVoid, AdditionalFormPars AdditionalFormPars, OptionalMethVarDeclL OptionalMethVarDeclL, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclNamespace(\n");
